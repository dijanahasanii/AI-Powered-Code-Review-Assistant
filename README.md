...
17. [Thesis evaluation, threat model & diagrams](#17-thesis-evaluation-threat-model--diagrams)
...
## 17. Thesis evaluation, threat model & diagrams

These artifacts are **additive documentation** and an **offline evaluation harness**; they do not change production API behaviour.
...
│   ├── fixtures/
│   │   └── cases.js        # 30 synthetic unified diffs
│   ├── run_evaluation.js
│   ├── results.md          # Regenerated by npm run evaluate
│   └── README.md
├── docs/
│   ├── DEVELOPMENT.md
